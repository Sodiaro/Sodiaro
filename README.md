...
<h3 align="center">Software Engineer · Backend-Focused</h3>

<p align="center">
  I build production-grade backend systems — scalable APIs, distributed services, and cloud infrastructure.<br/>
...
- RESTful API development — versioning, rate limiting, OpenAPI docs
- Authentication & authorization — JWT, RBAC, OAuth 2.0, social login
- Database engineering — schema design, indexing, query optimisation
- Async job processing with BullMQ and event-driven integrations
- Payment systems — Paystack & Flutterwave, webhooks, reconciliation
